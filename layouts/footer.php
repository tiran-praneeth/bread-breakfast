<!-- Start: FOOTER -->
    <footer>
      ...
      <hr class="footer-divider" style="display: none;">
      <div class="container">
        <p>
          &copy; 2017 Bread & Breakfast, All Rights Reserved.
        </p>
      </div>
    </footer>
    <!-- End: FOOTER -->
    ...
    <script type="text/javascript" src="assets/js/boot-business.js"></script>
  </body>
</html>
